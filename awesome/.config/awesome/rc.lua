...
awful.spawn("xss-lock /home/mrfluffy/.config/script/lock.sh")
awful.spawn("picom --experimental-backend")
awful.spawn("nitrogen --restore")
--awful.spawn("/usr/bin/dunst")
awful.spawn("nextcloud")
awful.spawn("fcitx5 -d")
naughty.suspend()
...
local gui_editor   = os.getenv("GUI_EDITOR") or "eovim"
local browser      = os.getenv("BROWSER") or "brave" 
local scrlocker    = "slock"

awful.util.terminal = terminal
awful.util.tagnames = { "MAIN", "DEV", "WWW", "TERM", "TEXT","FOLDER","SCHOOL","GAMES","MUSIC"}
...
-- {{{ Key bindings
    ...
    -- user added 
    awful.key({ altkey   }, "m",      function (c) awful.spawn("youtube-music")                         end,
              {description = "Youtube Music", group = "hotkeys"}),
    awful.key({ altkey   }, "e",      function (c) awful.spawn("mailspring")                         end,
              {description = "mailspring", group = "hotkeys"}),
    awful.key({altkey}, "d", function() os.execute("rofi -no-lazy-greb -show drun -theme /home/mrfluffy/.config/rofi-menus/themes/appsmenu.rasi") end,
        {description = "open rofi", group = "hotkeys"}),
     awful.key({modkey}, "Tab", function() os.execute("rofi  -no-lazy-greb -show window -theme /home/mrfluffy/.config/rofi-menus/themes/appsmenu.rasi") end,
        {description = "open rofi window", group = "hotkeys"}),
     awful.key({altkey}, "p", function() awful.spawn("kcolorchooser") end,
        {description = "open kde color picker", group = "hotkeys"}),
    -- Take a screenshot
    -- https://github.com/lcpz/dots/blob/master/bin/screenshot
    awful.key({}, "Print", function() os.execute("flameshot gui") end,
              {description = "take a screenshot", group = "hotkeys"}),
    awful.key({altkey},"f", function() awful.spawn("pcmanfm")end,
   ...
   --awful.key({ altkey, "Control" }, "l", function () os.execute(scrlocker) end,
	...
	awful.key({ }, "XF86AudioRaiseVolume", function ()
                os.execute("pamixer --allow-boost -i 5") end),
      -- os.execute("amixer set Master 5%+") end),
        awful.key({ }, "XF86AudioLowerVolume", function ()
                os.execute("pamixer --allow-boost -d 5") end),   
        awful.key({ }, "XF86AudioMicMute", function ()
                os.execute("pactl set-source-mute @DEFAULT_SOURCE@ toggle") end), 
    --os.execute("amixer set Master 5%-") end),
        awful.key({ }, "XF86AudioMute", function ()
                os.execute("amixer set Master toggle") end),
        awful.key({ }, "XF86AudioPlay", function ()
                os.execute("playerctl play-pause") end),
        awful.key({ }, "XF86AudioNext", function ()
                os.execute("playerctl next") end),
